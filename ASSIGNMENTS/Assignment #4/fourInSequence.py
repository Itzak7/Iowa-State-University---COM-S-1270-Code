...
# Isaac Aguilar            10-26-2025
# Assignment 4 (Four In Sequence)
# This is a code that reacreates the known game of four in row, but in this version 1 or 2 players can play (1 = against a computer)
# and players take turns dropping pieces and going until there is four in a sequence. You may also have the option to quit or read the rules.
...
def main():
    ...
    while running:
        ...
        if choice == "p":
            ...
            print("This game is called: Four in a sequence.")
            print("The goal for the game is to be the first player to make four in a sequence in either horizontally, vertically, or diagonally!")
            print("The board has seven columns and six rows with Player 1 using 'X' pieces and Player 2 (or the computer) using 'O' pieces.")
            print("Players (or computer) take the turns of selecting a column number from 0 to 6 to drop their piece into.")
            print("The game continues until one player forms four in a row or the board fills completely, resulting in a draw.")
            print("That's it!!! Good luck and have fun playing!")
        elif choice == "q":
